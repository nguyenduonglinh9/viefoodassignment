const listNew = document.querySelector(".list-news");
...
news.map((itemnew, index) => {
  ...
  divImg.style.border = "1px solid rgb(221,221,221)";
  ...
  pTitle.style.fontSize = "17px";
  pTitle.style.lineHeight = "19px";
  pTitle.style.color = "rgb(51,51,51)";
  pTitle.style.cursor = "pointer";
  pTitle.style.padding = "10px 10px";
  ...
  pTitle.addEventListener("mouseout", () => {
   ...
   pTitle.addEventListener("click", () => {
     localStorage.setItem("detailnew", JSON.stringify({
